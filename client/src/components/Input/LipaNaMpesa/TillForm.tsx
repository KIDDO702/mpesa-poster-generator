    ...
    <>
      <form>
        <div className="w-full">
          <label htmlFor="till-number" className="league-spartan-medium text-slate-600 dark:text-slate-300">Till Number</label>
          <input type="text" id="till-number" placeholder="123456"
