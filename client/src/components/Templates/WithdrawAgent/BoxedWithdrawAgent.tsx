...
function BoxedWithdrawAgent({ agentNumber, storeNumber, agentName }: Props) {
  ...
  return (
    <div className="w-full h-full border-2 border-mpesa-green">
      ...
      <div className="py-6 text-center text-black bg-mpesa-white rounded-t-md space-y-7">
        {/* Agent Number */}
        <div className="">
          <label className="text-2xl font-semibold uppercase">Agent Number</label>
          <div className="w-[80%] mx-auto flex flex-wrap justify-center gap-3 py-2 orbitron-black">
